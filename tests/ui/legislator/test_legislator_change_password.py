...
@allure.feature('Change Password as Legislator')
@pytest.mark.legislator
@pytest.mark.daily
@pytest.mark.ui
@pytest.mark.usefixtures('logout_after_test')
class TestLegislatorRestorePassword:  # pylint: disable=unused-argument, attribute-defined-outside-init
    ...
    def test_legislator_change_password_with_invalid_password(self, pre_test):
